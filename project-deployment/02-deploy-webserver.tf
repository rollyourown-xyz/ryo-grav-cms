...
resource "lxd_container" "grav-webserver" {
  remote     = var.host_id
  name       = join("-", [ var.host_id, local.project_id, "grav-webserver" ])
...
module "deploy-grav-webserver-cert-domains" {
  source = "../../ryo-service-proxy-discovery-config/module-deployment/modules/deploy-cert-domains"
...
module "deploy-grav-webserver-haproxy-backend-service" {
  source = "../../ryo-service-proxy-discovery-config/module-deployment/modules/deploy-haproxy-backend-services"
...
module "deploy-grav-webserver-haproxy-acl-configuration" {
  source = "../../ryo-service-proxy-discovery-config/module-deployment/modules/deploy-haproxy-configuration"
